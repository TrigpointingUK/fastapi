...
# from sqlalchemy.orm import Session  # Legacy JWT removed

# from app.core.config import settings  # Legacy JWT removed

# from app.core.security import create_access_token  # Legacy JWT removed
# from app.main import app  # Legacy JWT removed
# from app.models.user import User  # Legacy JWT removed
# from fastapi.testclient import TestClient  # Legacy JWT removed

# client = TestClient(app)  # Legacy JWT removed
